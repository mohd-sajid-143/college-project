...
<!-- MAIN Heading of Page -->
	<div class="title" id="title">
		<span>Daily Quiz on SyEduTech</span>
...
<div class="panel" id="panel">
	...
	<div class="left-side" id="left">
		<ul>
			...
			<li onclick="quizt(2)">Cloud Computing</li>
			<li onclick="quizt(3)">Blockchain</li>
			<li onclick="quizt(4)">Software Engineering</li>
			<li onclick="quizt(5)">C/C++</li>
			<li onclick="quizt(6)">Advance Java</li>
			<li onclick="quizt(7)">Python Programming</li>
			<li onclick="quizt(8)">JavaScript</li>
			<li onclick="quizt(9)">Data Structures</li>
			<li onclick="quizt(10)">Data Analytis</li>
